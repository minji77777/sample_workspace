...
import com.yedam.event.eventService;
...
public class Application {
	...
	public void run() {
			...
			case 1: // 회원
				System.out.println(
						"──────────────────────────────  <회원>  ──────────────────────────────────────────────");
				System.out.println("1. 로그인 | 2.회원가입 | 3.회원정보 변경 | 4.주문하기 | 5.리뷰 | 6. 공지사항 | 7. 이벤트  | 8. 종료 ");
				System.out.println(
						"───────────────────────────────────────────────────────────────────────────────────── ");
				...
				if (menuNo1 == 1) { // 로그인
					...
					break;
				} else if (menuNo1 == 8) { // <회원>탭 종료
					System.out.println("시작 창으로 나갑니다. ");
					break;
				}
				break;
